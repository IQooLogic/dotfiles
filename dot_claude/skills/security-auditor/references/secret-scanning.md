> **Note:** These patterns are language-agnostic reconnaissance techniques. The Implementer
> skill determines which automated scanners (Gitleaks, TruffleHog) are run in the pipeline.
