> **Note:** Technology choices (Node.js, Auth0, S3, etc.) in examples are illustrative.
> Architects should specify capability requirements and let the Implementer skill select
> appropriate tools per the Language Contract.
