> **Note:** Technology examples (Kafka, Auth0, Kong, etc.) are illustrative. The Implementer
> skill will define language-specific equivalents per the Language Contract.
