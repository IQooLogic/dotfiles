> **Note:** Examples use Supertest (Node.js). The security testing categories (auth, authz,
> input validation, headers) apply universally. Adapt to your language's HTTP testing tool.
