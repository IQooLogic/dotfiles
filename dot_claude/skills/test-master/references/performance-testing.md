> **Note:** Examples use k6 (JavaScript). The load testing concepts (load, stress, spike, soak)
> apply universally. For language-specific tools, consult the active Implementer skill.
